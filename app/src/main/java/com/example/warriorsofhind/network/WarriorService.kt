...
interface WarriorService {
    ...
    suspend fun getWarriors(@Header("X-JSON-Path") kings: String): Response<List<King>>

    @GET("/v3/b/64c4d2feb89b1e2299c7bf95?meta=false")
    suspend fun getWarriorsDetails(@Header("X-JSON-Path") name: String): Response<List<WarriorsItem>>
